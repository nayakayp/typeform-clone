...
function EditableOption({
  ...
  return (
    ...
    >
      ...
      <div className="flex h-5 w-5 shrink-0 items-center justify-center rounded-sm border-2 border-muted-foreground/40 transition-colors group-hover/option:border-primary/60">
...
export function CheckboxesPreview({ question }: CheckboxesPreviewProps) {
